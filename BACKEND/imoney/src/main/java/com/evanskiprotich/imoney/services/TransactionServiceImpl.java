...
import static com.evanskiprotich.imoney.utils.Constants.AUTHORIZATION_HEADER_STRING;
import static com.evanskiprotich.imoney.utils.Constants.BASIC_AUTH_STRING;
import static com.evanskiprotich.imoney.utils.Constants.BEARER_AUTH_STRING;
import static com.evanskiprotich.imoney.utils.Constants.CACHE_CONTROL_HEADER;
import static com.evanskiprotich.imoney.utils.Constants.CACHE_CONTROL_HEADER_VALUE;
import static com.evanskiprotich.imoney.utils.Constants.JSON_MEDIA_TYPE;
...
import com.evanskiprotich.imoney.config.MpesaConfiguration;
import com.evanskiprotich.imoney.dto.AccessTokenResponse;
import com.evanskiprotich.imoney.dto.B2CData;
import com.evanskiprotich.imoney.dto.B2CTransactionRequest;
...
import com.evanskiprotich.imoney.dto.RegisterUrlRequest;
...
import com.evanskiprotich.imoney.repository.B2CRepository;
import com.evanskiprotich.imoney.repository.C2BRepository;
import com.evanskiprotich.imoney.repository.ITransactionRepository;
import com.evanskiprotich.imoney.repository.TransactionRepository;
import com.evanskiprotich.imoney.utils.HelperUtility;
...
public class TransactionServiceImpl implements TransactionService{
    ...
    public RegisterUrlResponse registerUrl() {
        ...
        RequestBody body = RequestBody.create(MediaType.parse("application/json"), String.valueOf(registerUrlRequest));
    ...
    public SimulateTransactionResponse createC2BTransaction(C2BData c2BData) {
        ...
        @SuppressWarnings("deprecation")
        RequestBody body = RequestBody.create(MediaType.parse("application/json"), String.valueOf(simulateTransactionRequest));
...
//			return objectMapper.readValue(response.body().string(), SimulateTransactionResponse.class);
    ...
    public CommonSyncResponse performB2CTransaction(InternalB2CTransactionRequest internalB2CTransactionRequest) {
        ...
        @SuppressWarnings("deprecation")
        RequestBody body = RequestBody.create(MediaType.parse("application/json"), String.valueOf(b2CTransactionRequest));
